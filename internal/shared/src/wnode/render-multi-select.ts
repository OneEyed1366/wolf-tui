...
import type { MultiSelectViewState } from './view-states'

//#region Theme
export type MultiSelectRenderTheme = {
	styles: {
...
export const defaultMultiSelectTheme: MultiSelectRenderTheme = {
	styles: {
...
export function renderMultiSelect(
	state: MultiSelectViewState,
	theme: MultiSelectRenderTheme = defaultMultiSelectTheme
): WNode {
